...
class Record(models.Model):
    ...
    waste_code = models.CharField(blank=True, null=True,max_length=400,
                                    choices=EWC_CHOICES)
    ...
    recycling_method = models.CharField(null=True, blank=True,max_length=400, choices=RECYCLING_METHOD_CHOICES)
    tags = models.ManyToManyField('Tag', blank=True)
    disposal_method = models.CharField(null=True, blank=True,max_length=400, choices=DISPOSAL_METHOD_CHOICES)
    type_of_waste = models.CharField(null=True, blank=True,max_length=400, choices=WASTE_TYPE_CHOICES)
